...
const CareerApplicationPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Use environment variable for API URL during local development or custom backend.
    // For Vercel production, leave VITE_API_URL blank and use local /api routes.
