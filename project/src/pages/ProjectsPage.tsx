...
const projects = [
  { title: 'Autonomous AI Robot', category: 'AI & ML', grade: 'Grade 11', school: 'Delhi International School', description: 'Robot with YOLO-based object detection, autonomous path planning, and voice command control.', tech: ['Python', 'OpenCV', 'ROS'], award: 'National Science Olympiad — 1st Place', img: 'https://images.pexels.com/photos/3912981/pexels-photo-3912981.jpeg?auto=compress&cs=tinysrgb&w=800', color: '#0ea5e9' },
  { title: 'AI Health Wearable', category: 'AI & ML', grade: 'Grade 12', school: 'Bangalore Innovation High', description: 'Wearable that monitors vitals and uses LSTM models to predict anomalies in heart rate.', tech: ['TensorFlow', 'Arduino', 'BLE'], award: 'State Innovation Award', img: 'https://images.pexels.com/photos/8386434/pexels-photo-8386434.jpeg?auto=compress&cs=tinysrgb&w=800', color: '#a855f7' },
  { title: 'Smart Home IoT Hub', category: 'IoT', grade: 'Grade 9', school: 'Mumbai Tech Academy', description: 'Full home automation system with ESP32, custom PCB, and real-time cloud dashboard.', tech: ['ESP32', 'React', 'MQTT'], award: null, img: 'https://images.pexels.com/photos/1181671/pexels-photo-1181671.jpeg?auto=compress&cs=tinysrgb&w=800', color: '#10b981' },
  { title: 'Custom FPV Quad Drone', category: 'Drones', grade: 'Grade 10', school: 'Chennai Smart School', description: 'Built-from-scratch quadcopter with GPS navigation, FPV camera, and autonomous mission planning.', tech: ['Pixhawk', 'Python', 'GPS'], award: null, img: 'https://images.pexels.com/photos/3861958/pexels-photo-3861958.jpeg?auto=compress&cs=tinysrgb&w=800', color: '#06b6d4' },
  { title: 'AR Science Explorer', category: 'AR/VR', grade: 'Grade 8', school: 'Cochin Global Academy', description: 'Mobile AR app that overlays 3D science models on textbook pages using marker detection.', tech: ['Unity', 'ARCore', 'Blender'], award: 'EdTech Innovation Prize', img: 'https://images.pexels.com/photos/8721342/pexels-photo-8721342.jpeg?auto=compress&cs=tinysrgb&w=800', color: '#f59e0b' },
  { title: 'Smart Farming Station', category: 'IoT', grade: 'Grade 10', school: 'Pune Innovation School', description: 'IoT system with soil sensors, weather monitoring, and automated irrigation with app control.', tech: ['ESP8266', 'Node-RED', 'AWS'], award: 'Agriculture Innovation Award', img: 'https://images.pexels.com/photos/8386440/pexels-photo-8386440.jpeg?auto=compress&cs=tinysrgb&w=800', color: '#10b981' },
  { title: 'Robot Sorting Arm', category: 'Robotics', grade: 'Grade 7', school: 'Hyderabad STEM School', description: '6-DOF robotic arm with CV-powered color/shape sorting on a conveyor system.', tech: ['Raspberry Pi', 'OpenCV', 'Servo'], award: null, img: 'https://images.pexels.com/photos/3912981/pexels-photo-3912981.jpeg?auto=compress&cs=tinysrgb&w=800', color: '#06b6d4' },
  { title: 'Gesture-Controlled Car', category: 'Robotics', grade: 'Grade 8', school: 'Delhi International School', description: 'RC car controlled by hand gestures using MediaPipe hand-tracking and wireless communication.', tech: ['Python', 'MediaPipe', 'Arduino'], award: null, img: 'https://images.pexels.com/photos/1181671/pexels-photo-1181671.jpeg?auto=compress&cs=tinysrgb&w=800', color: '#0ea5e9' },
  { title: 'Smart Traffic System', category: 'Automation', grade: 'Grade 11', school: 'Mumbai Tech Academy', description: 'AI-powered traffic light system that dynamically adjusts timing based on vehicle density.', tech: ['Python', 'YOLO', 'Raspberry Pi'], award: 'Smart City Hackathon — Winner', img: 'https://images.pexels.com/photos/8386434/pexels-photo-8386434.jpeg?auto=compress&cs=tinysrgb&w=800', color: '#ec4899' },
];
  ...
  return (
    ...
    >
      <div className="relative h-48 overflow-hidden">
        ...
        {project.award && (
          <div className="absolute top-3 right-3 flex items-center gap-1 bg-yellow-500/20 border border-yellow-500/30 rounded-full px-2 py-1">
            <Star size={9} className="text-yellow-400 fill-yellow-400" />
            <span className="text-[9px] text-yellow-400 font-medium">Award Winner</span>
          </div>
        )}
      ...
      <div className="p-5">
        ...
        {project.award && <div className="flex items-center gap-1.5 mb-3"><Star size={10} className="text-yellow-400 fill-yellow-400" /><span className="text-[11px] text-yellow-400/80">{project.award}</span></div>}
